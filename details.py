...
class DetailsRoom:
    def __init__(self, root):
        ...
        # ==================================Labels and Entries========================================================================
        # Floor
        lbl_floor = Label(labelframeleft, text="Floor",
                                 font=("arial", 12, "bold"), padx=2, pady=6)
        lbl_floor.grid(row=0, column=0, sticky=W, padx=20)

        entry_floor = ttk.Entry(labelframeleft, text=self.var_floor, width=20, font=("arial", 13, "bold"))
        ...
        entry_RoomNo = ttk.Entry(labelframeleft, text=self.var_roomno, width=20, font=("arial", 13, "bold"))
        ...
        entry_RoomType = ttk.Entry(labelframeleft, text=self.var_roomType, width=20, font=("arial", 13, "bold"))
        ...
        btnReset = Button(btn_frame, command=self.reset_data, text="Reset", font=("arial", 12, "bold"), bg="black",
                          fg="gold", width=9)
    ...
    # =====================Delete Function================
    def mDelete(self):
        mDelete = messagebox.askyesno("Hotel Management System", "Do you want to delete this room",
                                      parent=self.root)
        if mDelete > 0:
            conn = mysql.connector.connect(host="localhost", username="root", password="", database="ayush_hotels")
            my_cursor = conn.cursor()
